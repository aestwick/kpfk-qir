    ...
    <>
      <style>{`
        @media print {
          ...
          .qir-container { max-width: 100%; padding: 0.5in; }
          .no-print { display: none !important; }
          .qir-entry { break-inside: avoid; }
          @page { margin: 0.75in; }
        }
      `}</style>
      <div className="qir-container max-w-4xl mx-auto px-6 py-8">
        ...
        {Object.entries(grouped).map(([category, catEntries]) => (
          <section key={category} className="mb-8">
            <h3 className="text-lg font-bold border-b-2 border-gray-800 pb-1 mb-4 uppercase">
              {category}
            </h3>
        ...
        <footer className="text-center text-sm text-gray-500 border-t pt-4 mt-8">
