...
const MiniBar = dynamic(() => import('@/app/components/dashboard-charts').then(m => ({ default: m.MiniBar })), {
  loading: () => <div className="h-12 bg-gray-100 rounded animate-pulse" />,
  ssr: false,
})
const HorizontalBars = dynamic(() => import('@/app/components/dashboard-charts').then(m => ({ default: m.HorizontalBars })), {
  loading: () => <div className="h-24 bg-gray-100 rounded animate-pulse" />,
  ssr: false,
})
const PipelineViz = dynamic(() => import('@/app/components/dashboard-charts').then(m => ({ default: m.PipelineViz })), {
  loading: () => <div className="h-28 bg-gray-100 rounded animate-pulse" />,
  ssr: false,
})
const DonutChart = dynamic(() => import('@/app/components/dashboard-charts').then(m => ({ default: m.DonutChart })), {
